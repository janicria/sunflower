...
- made CA's actually usable & safe
- fixed savestate! & restore_state! incrementing int_handler_count as a byte instead of a dword
...
- Also touched up some READMEs

## 0.1 -> 0.2

The kernel panic revamp is pretty much done, with development now focusing on other parts of the kernel

#### 0.1.3 - Kernel panic touchups 26/1/26
...
The floppy driver & libfs patches are now mostly-finished, despite a major libfs rework planned for a long time later.

#### 0.0.14 floppy & libfs de-spaghettification 30/12/25
...
#### 0.0.12 Misc improvements 8/12/25
...
#### 0.0.6 - Tests & better vga 29/9/25
...
#### 0.0.5 - TSS, debug macros & better double faults 27/9/25
...
#### 0.0.3 - Wrappers, better RTC & SysCmd 6 19/9/25
...
#### 0.0.2 - Syscmds, sysinfo & RTC 13/9/25
...
#### 0.0.1 - Startup tasks & better keyboard 13/9/25
